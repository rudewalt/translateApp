...
public class DemoHistoryRepository implements IHistoryRepository {
    ...
    public DemoHistoryRepository(){
        ...
        demoTransaltions.add(new Translation("привет","hi","ru","en",true, false));
        demoTransaltions.add(new Translation("пока","bye","ru","en",true, false));
        demoTransaltions.add(new Translation("мир","the world","ru","en",true, false));
        demoTransaltions.add(new Translation("привет","hi","ru","en",true, false));
        demoTransaltions.add(new Translation("пока","bye","ru","en",true, false));
        demoTransaltions.add(new Translation("мир","the world","ru","en",true, false));
        demoTransaltions.add(new Translation("привет","hi","ru","en",true, false));
